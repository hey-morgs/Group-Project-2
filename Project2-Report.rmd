...
#str(cases_data)
#str(deaths_data)
#any(is.na(cases_data$ConfirmedCases))
#any(is.na(cases_data$Deaths))
...
state_plot <- ggplot(df_ca_sum, aes(x = Date, y = Cases)) +
  geom_line(size = 2) +
  geom_vline(xintercept = start_date, linetype = "dashed", color = "blue", size = 1) +
  geom_vline(xintercept = vaccine_date, linetype = "dashed", color = "blue", size = 1) +
  geom_vline(xintercept = delta_date, linetype = "dashed", color = "red", size = 1) +
  geom_vline(xintercept = omicron_date, linetype = "dashed", color = "red", size = 1) +
